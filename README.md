...
| --- | --- | --- |
| **Классика** (по умолчанию) | Вечерний тёмно-медный взгляд | `#b56b3f` медь · `#22201d` уголь |
| **Свет** | Утреннее солнце, тёплый светлый вариант | `#e8a52a` янтарь · `#fdf7ea` кремовый |
| **Неон** | Ядовитый ночной, неоновая вывеска | `#c8ff00` кислотный лайм + `#ff2bd6` magenta · `#050510` |
